...
export default function AddMovieScreen({ onClose, onSuccess }: AddMovieScreenProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    genero: 'Ação',
    tipo: 'filme' as ProductionType,
    minhaNotas: '5',
    ondeAssistiu: 'Netflix',
    resumo: '',
  });
    ...
    <Modal animationType="slide" visible={true}>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          <Text style={styles.headerTitle}>Adicionar Produção</Text>
        ...
        <View style={styles.footer}>
          ...
          <TouchableOpacity onPress={handleAddProduction} style={styles.submitButton}>
